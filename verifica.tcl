...
#tempo: @14,5 minuti stop algoritmo 
#aumentare_risorse return values with best latency (smallest latency, <area max)
#set results_hls [optimize $start_main $total_area]; #doesn't return anything,  use lista_generale
optimize $start_main $total_area
#final results:
puts $lista_generale
